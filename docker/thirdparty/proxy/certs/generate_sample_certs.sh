...
openssl req -new -key "root-ca.key" -out "root-ca.csr" -sha256 -subj "/C=US/ST=Wyoming/L=Cody/O=MYORG/CN=Sample CA"
...
openssl req -new -key "site.key" -out "site.csr" -sha256 -subj "/C=US/ST=Wyoming/L=Cody/O=ETDEVELOPS/CN=localhost"
